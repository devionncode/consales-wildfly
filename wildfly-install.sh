...
WILDFLY_SERVICE_INSTANCE_NAME="consales"
PORT_HTTP=8180
PORT_HTTPS=8543
PORT_MNGNT=10090
PORT_MNGNTS=10093

echo "Configurando $WILDFLY_SERVICE_INSTANCE_NAME..."
...
WILDFLY_CONFIG=$WILDFLY_MODE"-full"
...
cp -R $WILDFLY_SERVICE_INSTANCE_DIR/$WILDFLY_FILENAME/* $WILDFLY_SERVICE_INSTANCE_DIR/
rm -R $WILDFLY_SERVICE_INSTANCE_DIR/$WILDFLY_FILENAME
...
sed -i -e 's,<inet-address value="${jboss.bind.address:127.0.0.1}"/>,<any-address/>,g' $WILDFLY_DIR/$WILDFLY_MODE/configuration/$WILDFLY_MODE-full.xml
